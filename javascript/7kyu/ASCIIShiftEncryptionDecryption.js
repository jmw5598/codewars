/*
  ...
  ----------------------------------
  The goal of this kata is to create a very simple ASCII encryption and
  decryption. The encryption algorithm should change each character relative to
  its location in the string.
...
function asciiEncrypt(plaintext) {
    return plaintext.split("")
      .map((e, i) => String.fromCharCode(e.charCodeAt(0) + i))
      .join("");
};
