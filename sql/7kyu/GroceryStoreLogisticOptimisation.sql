/*
  ...
  You have to find out how many unique products have each of the Producer. If
  you take only few items from some of them you will stop going there to save
  the gasoline:)
...
SELECT COUNT(*) AS unique_products, p.producer
FROM products AS p
GROUP BY p.producer
ORDER BY unique_products DESC, p.producer ASC
